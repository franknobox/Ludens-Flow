export type ModelCategory = "npc" | "quest" | "behavior_tree" | "multimodal" | "world_model" | "image" | "video" | "audio";
...
export const MODEL_CATEGORIES: { id: ModelCategory; label: string; icon: string; hint: string; status?: "available" | "coming_soon" }[] = [
  { id: "npc", label: "NPC 对话", icon: "💬", hint: "角色对话、闲聊互动" },
  { id: "quest", label: "任务", icon: "🧠", hint: "任务生成、目标拆解、奖励与状态" },
  { id: "behavior_tree", label: "行为树", icon: "🌳", hint: "角色决策、黑板变量、节点与转移" },
  { id: "multimodal", label: "多模态理解", icon: "👁️", hint: "图像解析、界面识别、音视频理解" },
  { id: "world_model", label: "世界模型", icon: "🌍", hint: "长线状态、生态和复杂系统推演", status: "coming_soon" },
...
export const MOCK_MODELS: GameModel[] = [
  ...
  },
  {
    ...
    categories: ["quest", "behavior_tree"],
    contextWindow: 128000,
